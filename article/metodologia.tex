...
As análises foram realizadas utilizando \foreign{softwares} gratuitos: Python 3.8 com a interface JupyterLab e as bibliotecas statsmodel (modelagem estatística), scikit-learn (\foreign{machine learning}), dentre outras auxiliares.
