...
\begin{figure}[t]
	...
	\caption{\foreign{Bubble-plot} da aprendizagem em função de cada um dos preditores. O raio de cada ponto representa a quantidade de pontos naquela posição.}
